  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset className='flex flex-col overflow-hidden'>
        ...
        <div className='flex h-16 items-center gap-4 border-b border-slate-200 bg-white px-6 flex-shrink-0'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <h1 className='text-lg font-semibold text-slate-900'>Teacher Dashboard</h1>
          </div>
        </div>

        {/* Main Content - Automatically adjusts with sidebar */}
        <div className='flex-1 p-6 bg-gradient-to-br from-slate-50 to-white overflow-auto'>{children}</div>
      </SidebarInset>
    </SidebarProvider>
  )
}
