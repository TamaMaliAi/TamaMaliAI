...
import { useStudentRouteParams } from '../../student-dashboard/[studentId]/hooks/useStudentRouteParams'
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className='flex h-16 items-center gap-4 border-b border-slate-200 bg-white px-6'>
          ...
          {/* Page title with student name */}
          <div className='flex items-center gap-2'>
            <div className='h-6 w-px bg-slate-300'></div>
            <h1 className='text-lg font-semibold text-slate-900'>
              {loading ? (
                <span className='inline-block h-6 w-48 animate-pulse rounded bg-slate-200'></span>
              ) : (
                dashboardTitle
              )}
            </h1>
